    ...
    public void onCrunchButtonClick(View view){
        try {
            ...
            String repsDone = String.valueOf(getReps.getText());
                ...
                //wathanText.setText("Wathan Equation: " + Integer.toString(wrm));
              //mayhewText.setText("Mayhew Equation: " + Integer.toString(mrm));
                averageText.setText("Predicted 1RM:" + Integer.toString((average)));
